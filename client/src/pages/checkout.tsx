...
if (!import.meta.env.VITE_STRIPE_PUBLIC_KEY) {
  console.warn(
    "VITE_STRIPE_PUBLIC_KEY is not set. Stripe payments will not work correctly.",
  );
}
    ...
    const createPaymentIntent = async () => {
      try {
        ...
        toast({
          title: "Payment Error",
          description:
            "There was a problem setting up the payment. Please try again later.",
          variant: "destructive",
        });
      } finally {
        setLoading(false);
                ...
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">
                      We couldn't set up the payment process. Please try again
